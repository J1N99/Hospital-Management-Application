...
// Scale the image if needed
                ...
                val thankYouCell = PdfPCell(
                    Phrase("Thank you for your appointment.", FontFactory.getFont(
                ...
                val termsCell = PdfPCell(
                    Phrase("Terms and conditions: This is an automated generated PDF; signature is not needed.", FontFactory.getFont(
                        FontFactory.HELVETICA_BOLD))
                )
                termsCell.colspan = 4
